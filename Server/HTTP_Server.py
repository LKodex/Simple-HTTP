...
def replyNotFoundRequest(socket):
    ...
    htmlNotFound = '<!DOCTYPE html><html><head><link rel="stylesheet" href="/style/error.css"><title>404 - Not Found</title></head><body><h1>Error 404 - Not Found</h1></body></html>'
...
def replyBadRequest(socket):
    ...
    htmlBadRequest = '<!DOCTYPE html><html><head><link rel="stylesheet" href="/style/error.css"><title>400 - Bad Request</title></head><body><h1>Error 400 - Bad Request</h1></body></html>'
    socket.send(httpHeader.encode())
...
def replyNotImplemented(socket):
    ...
    htmlNotImplemented = '<!DOCTYPE html><html><head><link rel="stylesheet" href="/style/error.css"><title>501 - Not Implemented</title></head><body><h1>Error 501 - Not Implemented</h1></body></html>'
    socket.send(httpHeader.encode())
